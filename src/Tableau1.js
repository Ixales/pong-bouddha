class Tableau1 extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image('Mauvais espris','assets/Ame2.png');
        this.load.image('bouddha','assets/bouddha2.png');
        this.load.image('circle','assets/YY.png');
        this.load.image('R','assets/r.png');
        this.load.image('R2','assets/r2.png');
        this.load.image('fond','assets/fond3.jpg');
        for(let j=1;j<=49;j++) {
            this.load.image('backg' + j, 'assets/fond/frame-' + j + '.gif');
        }
    }
    ...
    create(){
        ...
        this.haut = this.physics.add.sprite(0, 0, 'R2').setOrigin(0, 0)
        this.haut.setDisplaySize(this.largeur, 20)
        this.haut.body.setAllowGravity(false)
        this.haut.setImmovable(true);
        this.bas = this.physics.add.sprite(0, 480, 'R').setOrigin(0, 0)
        this.bas.setDisplaySize(this.largeur, 20)
        this.bas.body.setAllowGravity(false)
        this.bas.setImmovable(true);
        this.player1 = this.physics.add.sprite(50, 360, 'Mauvais espris')
        this.player1.setDisplaySize(100, 100)
        this.player1.body.setAllowGravity(false)
        this.player2 = this.physics.add.sprite(920, 360, 'bouddha')
        ...
        this.joueurGauche = new Joueur('Mauvais espris','joueurGauche')
        this.joueurDroite = new Joueur('Bouddha','joueurDroite')
